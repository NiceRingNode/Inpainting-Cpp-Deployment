...
QT_MOC_LITERAL(5, 51, 21), // "mouseDoubleClickEvent"
QT_MOC_LITERAL(6, 73, 12), // "QMouseEvent*"
QT_MOC_LITERAL(7, 86, 24), // "on_originsize_rb_toggled"
QT_MOC_LITERAL(8, 111, 7), // "checked"
QT_MOC_LITERAL(9, 119, 24) // "on_screensize_rb_toggled"

    },
    "InpaintingSubWindow\0paintEvent\0\0"
    "QPaintEvent*\0event\0mouseDoubleClickEvent\0"
    "QMouseEvent*\0on_originsize_rb_toggled\0"
...
void InpaintingSubWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_originsize_rb_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->on_screensize_rb_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
